...
<h3 align="center">Junior Data Analyst / BI Analyst</h3>

Училась на факультете "Информатика и вычислительная техника" в МГТУ им. Н. Э. Баумана. Cоздаю аналитические решения на основе данных: от сбора и обработки до визуализации и формулирования бизнес-инсайтов. Активно развиваюсь в аналитике данных и BI. </h3>
## My Skill Set  
...
| Проект | Описание |
|--------|-----------|
| [📈 Эффективность рекламы](https://github.com/AlexSolov28/Power-BI/tree/main/Эффективность%20рекламы) | Анализ рекламных кампаний, расчёт ROAS, CPL, CPA и выявление неэффективных источников. |
| [💬 CSI / NPS](https://github.com/AlexSolov28/Power-BI/tree/main/CSI%20NPS) | Анализ удовлетворённости клиентов, расчёт CSI и NPS, рекомендации по улучшению клиентского опыта. |
| [🏗️ Строительство сети](https://github.com/AlexSolov28/Power-BI/tree/main/Строительство%20сети) | План–факт анализ строительных работ, контроль динамики кабеля и монтажа оборудования. | 
...
- Использовать **SQL-запросы** для анализа данных и создания витрин.  
